...
\introduction{}
%%% PARTIE ENTREPRISE
Je postule à votre entreprise \textit{Morgan Stanley} car je suis très intéressé par vos propositions d'\textbf{Développeur Java}. Je suis impressionné par le poids de votre entreprise dans le domaine financier. Ces responsabilités dans ce domaine vous amènent à avoir une infrastructure informatique conséquente et j'aimerais participer à cette organisation avec vos équipes. Le développement d'outils utiles pour la productivité, la gestion de données ou l'automatisation est sans doute ce que je préfère. J'ai codé un script \textbf{Perl} pour gérer les différentes lettres de motivation et mes CV dans ma recherche d'emploi par exemple.
%%%
